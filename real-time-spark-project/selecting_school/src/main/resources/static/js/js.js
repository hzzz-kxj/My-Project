...
legend: {
  data: ['城镇职工参保量', '在职职工参保量', '企业(含其他)参保量','城镇职工参保趋势','在职职工参保趋势','在职企业(含其他)参保趋势'],
  right: '1%', width:'100%',
  textStyle: {
      color: "#fff"
  },
 ...
 "series": [
  
   {
     "name": "城镇职工参保量",
     "type": "bar",
     "data": [36.6,38.80, 40.84, 41.60,50],
     "barWidth": "15%",
     "itemStyle": {
       "normal": {
        barBorderRadius: 15,
   ...
   data: ['17年3月', '17年6月', '17年9月', '17年12月', '18年3月', '18年6月', '18年9月', '18年12月', '19年3月', '19年6月', '19年9月', '19年12月']
    ...
    function echarts_3() {
        ...
        option = {
          ...
          xAxis: {
            type: 'category',
            data: ['北京','上海','天津','重庆','广州','武汉','成都','长沙','郑州','西安1'],
            axisLine: {
              lineStyle: {
                color: 'white'
    ...
    function echarts_4() {
      ...
      option = {
              ...
              yAxis: [{
                      ...
                      data: ['北京','上海','天津','重庆','广州','武汉','成都','长沙','郑州','西安']
                      ...
                      data: [1514, 1619, 1623,1968,2158,2456 ,3506,4664,8390,1234]
              ...
              series: [{
                  ...
                  type: 'bar',
                  yAxisIndex: 0,
                  data: [25,30,34,40,43,48,52,56,70,80],
                  label:{
                        normal:{
                          show:true,
                          position:'right',
